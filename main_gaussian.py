...
def parse_args(args=None):
    ...
    parser.add_argument('--geo', default='vec', type=str, choices=['vec', 'gaussian', 'beta'], help='the reasoning model, vec for GQE, gaussian for PERM, beta for BetaE')
    ...
    parser.add_argument('-gaussianm', '--gaussian_mode', default="(none,0.02)", type=str, help='(offset activation,center_reg) for PERM')
